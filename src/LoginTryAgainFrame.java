...
public class LoginTryAgainFrame extends JFrame {
	...
	private Image img_cannotfind = new ImageIcon(HomeFrame.class.getResource("res/cannotfind.png")).getImage().getScaledInstance(350, 250, Image.SCALE_SMOOTH);
	/**
	 ...
	 * Create the frame.
	 */
	public LoginTryAgainFrame() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginTryAgainFrame.class.getResource("/res/logoStock.png")));
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 567, 377);
		setTitle("StockSign");
		setResizable(false);
		...
		cannotfind_img_lbl.setBounds(81, 36, 264, 191);
		cannotfind_img_lbl.setIcon(new ImageIcon(img_cannotfind));
		contentPane.add(cannotfind_img_lbl);
		
		JLabel lblNewLabel_1_1 = new JLabel("CANNOT FIND ACCOUNT!");
		lblNewLabel_1_1.setForeground(new Color(242, 202, 165));
		lblNewLabel_1_1.setFont(new Font("Segoe UI", Font.BOLD, 30));
		lblNewLabel_1_1.setBounds(91, 193, 381, 54);
		...
		tryAgain_btn.setBounds(157, 281, 234, 37);
