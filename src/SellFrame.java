...
public class SellFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SellFrame frame = new SellFrame(prodIDInt, productNameString);
	...
	class PanelButtonMouseAdapter extends MouseAdapter {
	    ...
	    public void mouseClicked(MouseEvent e) {
	        if (panel == confirm_btn) {
	            ...
	            SellItemsFrame sellItemsFrame = new SellItemsFrame(prodIDInt, productNameString);
...
//    }
	 ...
	 * Create the frame.
	 */
	public SellFrame (int prodID, String productName) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(SellFrame.class.getResource("/res/logoStock.png")));
		...
		JLabel lblNewLabel = new JLabel("CONFIRM SELLING ITEMS");
    ...
    private void initializeTable() {
        ...
        tableModel.addRow(new Object[] { getProdID(), getProductName() });

        table.setModel(tableModel);
    }
	public static void updateTable(Object[] productInfo, DefaultTableModel tableModel) {
